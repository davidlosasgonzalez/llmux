...
``council.yaml`` — enabling flips visibility, it does not override cost safety.
...
# of authoring; validation at runtime (`fcc-council providers validate`) is the
...
_POLICY: dict[str, ProviderFreeAccess] = {
    ...
    # they can be enabled in council.yaml once confirmed generous without a card.
