...
from .quota import classify_failure
...
class ProviderModelInvoker:
    """Bridges council model calls onto FCC providers, with a provider cache."""
    ...
    async def invoke(
        ...
        *,
        ...
        try:
            ...
            logger.warning("council.provider.error model={} err={}", model.key, exc)
    ...
    async def cleanup(self) -> None:
        for provider in self._providers.values():
            try:
                ...
                logger.debug("council.provider.cleanup error: {}", exc)
