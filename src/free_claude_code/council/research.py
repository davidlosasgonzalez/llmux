...
lets the council answer version/limit/pricing questions from current sources
...
# CouncilConfig into deterministic character caps for truncation.
_CHARS_PER_TOKEN = 4
...
class ResearchResult:
    ...
    def summary(self) -> ResearchSummary:
        """Project onto the SDK-free summary stored on the CouncilResult."""
...
class ResearchService:
    ...
    async def investigate(self, prompt: str) -> ResearchResult:
        ...
        try:
            ...
            logger.warning("council.research.search_failed query={} err={}", query, exc)
    ...
    async def _safe_fetch(self, url: str) -> str:
        try:
            ...
            logger.info("council.research.fetch_failed url={} err={}", url, exc)
            return ""
