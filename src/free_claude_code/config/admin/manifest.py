...
_NON_PROVIDER_FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        "MESSAGING_SESSION_BACKEND",
        "Messaging Session Backend",
        "messaging",
        "select",
        settings_attr="messaging_session_backend",
        default="claude",
        options=("claude", "agent"),
        session_sensitive=True,
    ),
    ConfigFieldSpec(
        ...
        "messaging",
        "number",
        settings_attr="messaging_agent_job_timeout_s",
        default="600",
        session_sensitive=True,
    ),
    ConfigFieldSpec(
        "MESSAGING_AGENT_APPROVAL_TIMEOUT_S",
        "Agent Approval Timeout (s)",
        "messaging",
        "number",
        settings_attr="messaging_agent_approval_timeout_s",
        default="120",
        session_sensitive=True,
    ),
    ConfigFieldSpec(
        "MESSAGING_AGENT_AUTO_APPROVE",
        "Agent Auto-Approve Tools",
        "messaging",
        "boolean",
        settings_attr="messaging_agent_auto_approve",
        default="false",
        session_sensitive=True,
    ),
    ConfigFieldSpec(
