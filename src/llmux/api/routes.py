...
from llmux.application.ports import ProviderResolver, RequestRuntimeLease
from llmux.config.model_refs import parse_provider_type
...
async def list_models(
    ...
    trace_event(stage="ingress", event="llmux.api.models.list", source="api")
