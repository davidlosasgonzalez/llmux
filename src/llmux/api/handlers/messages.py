...
from llmux.api.detection import is_safety_classifier_request
from llmux.api.optimization_handlers import try_optimizations
from llmux.api.request_errors import (
    http_status_for_unexpected_api_exception,
    log_unexpected_api_exception,
    require_non_empty_messages,
    unexpected_http_exception,
)
from llmux.api.request_ids import new_request_id
...
from llmux.api.web_tools.request import (
    is_web_server_tool_request,
    unsupported_server_tool_error,
)
from llmux.api.web_tools.streaming import stream_web_server_tool_response
from llmux.application.errors import ApplicationError, InvalidRequestError
from llmux.application.execution import ProviderExecutor, TokenCounter
...
from llmux.config.paths import config_dir_path
...
from llmux.core.diagnostics import safe_exception_message
from llmux.core.failures import ExecutionFailure, find_execution_failure
from llmux.core.quota import DailyExhaustionStore, QuotaTracker
from llmux.core.trace import trace_event
...
class MessagesHandler:
    ...
    def _intercept_web_server_tool(
        ...
        trace_event(
            stage="routing",
            event="llmux.api.optimization.web_server_tool",
            source="api",
            model=routed.request.model,
        )
    ...
    def _intercept_local_optimization(
        ...
        trace_event(
            stage="routing",
            event="llmux.api.optimization.short_circuit",
            source="api",
            model=routed.request.model,
        )
