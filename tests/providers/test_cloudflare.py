...
from llmux.config.provider_catalog import CLOUDFLARE_AI_REST_ROOT
...
from llmux.providers.cloudflare import (
    CloudflareProvider,
...
def test_init_composes_account_scoped_openai_chat_base_url(
    ...
    with (
        patch("llmux.providers.openai_chat.provider.AsyncOpenAI") as mock_openai,
