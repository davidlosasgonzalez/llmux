"""The deep-council skill installer writes the file and backs up existing ones."""

from free_claude_code.council.skill import (
    install_skill,
...
def test_install_skill_writes_and_backs_up(tmp_path, monkeypatch):
    ...
    assert "name: deep-council" in content
...
def test_mcp_registration_snippet_mentions_server():
    ...
    assert "fcc-council serve-mcp" in snippet
