...
def test_anthropic_request_model_is_core_owned_and_permissive() -> None:
    ...
    assert MessagesRequest.__module__ == "llmux.core.anthropic.models"
...
def test_anthropic_response_models_are_protocol_owned() -> None:
    assert MessagesResponse.__module__ == "llmux.core.anthropic.models"
    assert TokenCountResponse.__module__ == "llmux.core.anthropic.models"
